...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "uibinderindex" because\n';
  ...
  $wnd.__gwt_activeModules['uibinderindex'] = {
    'moduleName' : 'uibinderindex',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/uibinderindex.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['uibinderindex'].superdevmode = true;

  var expectedSuffix = '/uibinderindex.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + uibinderindex + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:uibinderindex';
  var devModeSessionKey = '__gwtDevModeSession:uibinderindex';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/uibinderindex/uibinderindex.nocache.js';
  ...
  $wnd.__gwt_activeModules['uibinderindex'].canRedirect = true;
  $wnd.__gwt_activeModules['uibinderindex'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING uibinderindex';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/uibinderindex?user.agent=' + ua + '&_callback=' + callback;
